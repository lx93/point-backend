...
var PlivoRestError = exports.PlivoRestError = function (_Error) {
  _inherits(PlivoRestError, _Error);

  function PlivoRestError() {
    _classCallCheck(this, PlivoRestError);

    return _possibleConstructorReturn(this, (PlivoRestError.__proto__ || Object.getPrototypeOf(PlivoRestError)).apply(this, arguments));
  }
...
var AuthenticationError = exports.AuthenticationError = function (_PlivoRestError5) {
  _inherits(AuthenticationError, _PlivoRestError5);
